...
export class Laya3D {
    ...
    private static __init__(
        ...
        if (!Render.supportWebGLPlusRendering) {
            ...
            (<any>LayaGL.instance).createCommandEncoder = function (
                reserveSize: number = 128,
                adjustSize: number = 64,
                isSyncToRenderThread: boolean = false,
            ): CommandEncoder {
                return new CommandEncoder(
                    this,
                    reserveSize,
                    adjustSize,
                    isSyncToRenderThread,
                );
            };
        }
        config._multiLighting =
            config.enableMultiLight &&
            SystemUtils.supportTextureFormat(TextureFormat.R32G32B32A32);
        ...
        Laya3D._innerFirstLevelLoaderManager.on(
            Event.ERROR,
            null,
            Laya3D._eventLoadManagerError,
        );
        Laya3D._innerSecondLevelLoaderManager.on(
            Event.ERROR,
            null,
            Laya3D._eventLoadManagerError,
        );
        Laya3D._innerThirdLevelLoaderManager.on(
            Event.ERROR,
            null,
            Laya3D._eventLoadManagerError,
        );
        Laya3D._innerFourthLevelLoaderManager.on(
            Event.ERROR,
            null,
            Laya3D._eventLoadManagerError,
        );
    ...
    private static enableNative3D(): void {
        ...
        if (Render.supportWebGLPlusRendering) {
            //替换ShaderData的函数
            shaderData.prototype._initData =
                shaderData.prototype._initDataForNative;
            shaderData.prototype.setBool =
                shaderData.prototype.setBoolForNative;
            shaderData.prototype.getBool =
                shaderData.prototype.getBoolForNative;
            ...
            shaderData.prototype.setNumber =
                shaderData.prototype.setNumberForNative;
            shaderData.prototype.getNumber =
                shaderData.prototype.getNumberForNative;
            shaderData.prototype.setVector =
                shaderData.prototype.setVectorForNative;
            shaderData.prototype.getVector =
                shaderData.prototype.getVectorForNative;
            shaderData.prototype.setVector2 =
                shaderData.prototype.setVector2ForNative;
            shaderData.prototype.getVector2 =
                shaderData.prototype.getVector2ForNative;
            shaderData.prototype.setVector3 =
                shaderData.prototype.setVector3ForNative;
            shaderData.prototype.getVector3 =
                shaderData.prototype.getVector3ForNative;
            shaderData.prototype.setQuaternion =
                shaderData.prototype.setQuaternionForNative;
            shaderData.prototype.getQuaternion =
                shaderData.prototype.getQuaternionForNative;
            shaderData.prototype.setMatrix4x4 =
                shaderData.prototype.setMatrix4x4ForNative;
            shaderData.prototype.getMatrix4x4 =
                shaderData.prototype.getMatrix4x4ForNative;
            shaderData.prototype.setBuffer =
                shaderData.prototype.setBufferForNative;
            shaderData.prototype.getBuffer =
                shaderData.prototype.getBufferForNative;
            shaderData.prototype.setTexture =
                shaderData.prototype.setTextureForNative;
            shaderData.prototype.getTexture =
                shaderData.prototype.getTextureForNative;
            shaderData.prototype.setAttribute =
                shaderData.prototype.setAttributeForNative;
            shaderData.prototype.getAttribute =
                shaderData.prototype.getAttributeForNative;
            shaderData.prototype.cloneTo =
                shaderData.prototype.cloneToForNative;
            shaderData.prototype.getData =
                shaderData.prototype.getDataForNative;
            shader3D.prototype._uniformMatrix2fv =
                shader3D.prototype._uniformMatrix2fvForNative;
            shader3D.prototype._uniformMatrix3fv =
                shader3D.prototype._uniformMatrix3fvForNative;
            shader3D.prototype._uniformMatrix4fv =
                shader3D.prototype._uniformMatrix4fvForNative;
            LayaGLRunner.uploadShaderUniforms =
                LayaGLRunner.uploadShaderUniformsForNative;
        }

        if (Render.supportWebGLPlusCulling) {
            frustumCulling.renderObjectCulling =
                FrustumCulling.renderObjectCullingNative;
        }

        if (Render.supportWebGLPlusAnimation) {
            avatar.prototype._cloneDatasToAnimator =
                avatar.prototype._cloneDatasToAnimatorNative;
            var animationClip: any = AnimationClip;
            animationClip.prototype._evaluateClipDatasRealTime =
                animationClip.prototype._evaluateClipDatasRealTimeForNative;
            skinnedMeshRender.prototype._computeSkinnedData =
                skinnedMeshRender.prototype._computeSkinnedDataForNative;
        }
    }
    ...
    private static _addHierarchyInnerUrls(
        ...
        urlMap: any[],
        urlVersion: string,
        hierarchyBasePath: string,
        path: string,
        type: string,
        constructParams: any = null,
        propertyParams: any = null,
    ): string {
        var formatUrl: string = Laya3D.formatRelativePath(
            hierarchyBasePath,
            path,
        );
    ...
    private static _getSprite3DHierarchyInnerUrls(
        ...
        switch (node.type) {
            case 'Scene3D': //TODO:应该自动序列化类型
                ...
                for (i = 0, n = lightmaps.length; i < n; i++) {
                    ...
                    lightMap.path = Laya3D._addHierarchyInnerUrls(
                        fourthLelUrls,
                        subUrls,
                        urlVersion,
                        hierarchyBasePath,
                        lightMap.path,
                        Laya3D.TEXTURE2D,
                        lightMap.constructParams,
                        lightMap.propertyParams,
                    );
                }
                var reflectionTextureData: string = props.reflectionTexture;
                reflectionTextureData &&
                    (props.reflectionTexture = Laya3D._addHierarchyInnerUrls(
                        thirdLevelUrls,
                        subUrls,
                        urlVersion,
                        hierarchyBasePath,
                ...
                if (props.sky) {
                    ...
                    skyboxMaterial &&
                        (skyboxMaterial.path = Laya3D._addHierarchyInnerUrls(
                            secondLevelUrls,
                            subUrls,
                            urlVersion,
                            hierarchyBasePath,
            ...
            case 'Camera':
                ...
                skyboxMatData &&
                    (skyboxMatData.path = Laya3D._addHierarchyInnerUrls(
                        secondLevelUrls,
                        subUrls,
                        urlVersion,
                        hierarchyBasePath,
            ...
            case 'SkinnedMeshSprite3D':
                ...
                meshPath &&
                    (props.meshPath = Laya3D._addHierarchyInnerUrls(
                        firstLevelUrls,
                        subUrls,
                        urlVersion,
                        hierarchyBasePath,
                ...
                if (materials)
                    for (i = 0, n = materials.length; i < n; i++)
                        materials[i].path = Laya3D._addHierarchyInnerUrls(
                            secondLevelUrls,
                            subUrls,
                            urlVersion,
                            hierarchyBasePath,
            ...
            case 'ShuriKenParticle3D':
                if (props.main) {
                    ...
                    mesh &&
                        (resources.mesh = Laya3D._addHierarchyInnerUrls(
                            firstLevelUrls,
                            subUrls,
                            urlVersion,
                            hierarchyBasePath,
                    ...
                    material &&
                        (resources.material = Laya3D._addHierarchyInnerUrls(
                            secondLevelUrls,
                            subUrls,
                            urlVersion,
                            hierarchyBasePath,
                    ...
                    props.material.path = Laya3D._addHierarchyInnerUrls(
                        secondLevelUrls,
                        subUrls,
                        urlVersion,
                        hierarchyBasePath,
            ...
            for (var k: number = 0, p: number = components.length; k < p; k++) {
                ...
                switch (component.type) {
                    case 'Animator':
                        ...
                        avatarData &&
                            (avatarData.path = Laya3D._addHierarchyInnerUrls(
                                fourthLelUrls,
                                subUrls,
                                urlVersion,
                                hierarchyBasePath,
                        ...
                        if (!clipPaths) {
                            ...
                            for (i = 0; i < layersData.length; i++) {
                                ...
                                for (
                                    ...
                                    clipPath &&
                                        (states[
                                            j
                                        ].clipPath = Laya3D._addHierarchyInnerUrls(
                                            fourthLelUrls,
                                            subUrls,
                                            urlVersion,
                                            hierarchyBasePath,
                            ...
                            for (i = 0, n = clipPaths.length; i < n; i++)
                                clipPaths[i] = Laya3D._addHierarchyInnerUrls(
                                    fourthLelUrls,
                                    subUrls,
                                    urlVersion,
                                    hierarchyBasePath,
                    ...
                    case 'CharacterController':
                        ...
                        for (i = 0; i < shapes.length; i++) {
                            ...
                            if (shape.type === 'MeshColliderShape') {
                                ...
                                mesh &&
                                    (shape.mesh = Laya3D._addHierarchyInnerUrls(
                                        firstLevelUrls,
                                        subUrls,
                                        urlVersion,
                                        hierarchyBasePath,
        ...
        for (i = 0, n = children.length; i < n; i++)
            Laya3D._getSprite3DHierarchyInnerUrls(
                children[i],
                firstLevelUrls,
                secondLevelUrls,
                thirdLevelUrls,
    ...
    private static _onHierarchylhLoaded(loader: Loader, lhData: any): void {
        ...
        var urlCount: number =
            firstLevUrls.length + secondLevUrls.length + forthLevUrls.length;
        ...
        if (forthLevUrls.length > 0) {
            ...
            var processHandler: Handler = Handler.create(
                null,
                Laya3D._onProcessChange,
                [loader, weight, processCeil],
                false,
            );
            Laya3D._innerFourthLevelLoaderManager._create(
                forthLevUrls,
                false,
                Handler.create(
                    null,
                    Laya3D._onHierarchyInnerForthLevResouLoaded,
                    [
                        loader,
                        processHandler,
                        lhData,
                        ...
                        secondLevUrls,
                        thirdLevUrls,
                        weight + processCeil * forthLevUrls.length,
                        processCeil,
                    ],
                ),
                processHandler,
    ...
    private static _onHierarchyInnerForthLevResouLoaded(
        ...
        if (thirdLevUrls.length > 0) {
            var process: Handler = Handler.create(
                null,
                Laya3D._onProcessChange,
                [loader, processOffset, processCeil],
                false,
            );
            Laya3D._innerThirdLevelLoaderManager._create(
                thirdLevUrls,
                false,
                Handler.create(
                    null,
                    Laya3D._onHierarchyInnerThirdLevResouLoaded,
                    [
                        loader,
                        process,
                        lhData,
                        ...
                        firstLevUrls,
                        secondLevUrls,
                        processOffset + processCeil * secondLevUrls.length,
                        processCeil,
                    ],
                ),
                processHandler,
    ...
    private static _onHierarchyInnerThirdLevResouLoaded(
        ...
        if (secondLevUrls.length > 0) {
            ...
            Laya3D._innerSecondLevelLoaderManager._create(
                secondLevUrls,
                false,
                Handler.create(
                    null,
                    Laya3D._onHierarchyInnerSecondLevResouLoaded,
                    [
                        loader,
                        process,
                        lhData,
    ...
    private static _onHierarchyInnerSecondLevResouLoaded(
        ...
        if (firstLevUrls.length > 0) {
            ...
            Laya3D._innerFirstLevelLoaderManager._create(
                firstLevUrls,
                false,
                Handler.create(
                    null,
                    Laya3D._onHierarchyInnerFirstLevResouLoaded,
                    [loader, process, lhData, subUrls],
                ),
                processHandler,
                null,
                null,
    ...
    private static _onHierarchyInnerFirstLevResouLoaded(
        ...
        var item: Node =
            lhData.data.type === 'Scene3D'
                ? Scene3DUtils._parseScene(
                      lhData,
                      loader._propertyParams,
                      loader._constructParams,
                  )
                : Scene3DUtils._parse(
                      lhData,
                      loader._propertyParams,
    ...
    private static _onMaterilLmatLoaded(loader: Loader, lmatData: any): void {
            ...
            case 'LAYAMATERIAL:02':
                ...
                if (textures) {
                    for (i = 0, n = textures.length; i < n; i++) {
                        ...
                        if (tex2DPath) {
                            formatSubUrl = Laya3D.formatRelativePath(
                                materialBasePath,
                                tex2DPath,
                            );
                            urlVersion &&
                                (formatSubUrl = formatSubUrl + urlVersion);

                            urls.push({
                                url: formatSubUrl,
                                constructParams: tex2D.constructParams,
                                propertyParams: tex2D.propertyParams,
                            }); //不指定类型,自动根据后缀判断Texture2D或TextureCube
        ...
        if (urlCount > 0) {
            var processHandler: Handler = Handler.create(
                null,
                Laya3D._onProcessChange,
                [loader, lmatWeight, urlCount / totalProcessCount],
                false,
            );
            Laya3D._innerFourthLevelLoaderManager._create(
                urls,
                false,
                Handler.create(null, Laya3D._onMateialTexturesLoaded, [
                    loader,
                    processHandler,
                    lmatData,
                    subUrls,
    ...
    private static _onMateialTexturesLoaded(
        ...
        loader._cache = loader._createCache;
        var mat: Material = Material._parse(
            lmatData,
            loader._propertyParams,
            loader._constructParams,
        );
    ...
    private static _loadAvatar(loader: Loader): void {
        loader.on(Event.LOADED, null, function (data: any): void {
            loader._cache = loader._createCache;
            var avatar: Avatar = Avatar._parse(
                data,
                loader._propertyParams,
                loader._constructParams,
            );
    ...
    private static _loadAnimationClip(loader: Loader): void {
        loader.on(Event.LOADED, null, function (data: any): void {
            loader._cache = loader._createCache;
            var clip: AnimationClip = AnimationClip._parse(
                data,
                loader._propertyParams,
                loader._constructParams,
            );
    ...
    private static _loadTexture2D(loader: Loader): void {
        ...
        loader.on(Event.LOADED, null, function (image: any): void {
            loader._cache = loader._createCache;
            var tex: Texture2D = Texture2D._parse(
                image,
                loader._propertyParams,
                loader._constructParams,
            );
    ...
    private static _onTextureCubeLtcLoaded(loader: Loader, ltcData: any): void {
        ...
        var processHandler: Handler = Handler.create(
            null,
            Laya3D._onProcessChange,
            [loader, ltcWeight, 6 / 7],
            false,
        );
        Laya3D._innerFourthLevelLoaderManager.load(
            urls,
            Handler.create(null, Laya3D._onTextureCubeImagesLoaded, [
                loader,
                urls,
                processHandler,
            ]),
    ...
    private static _onTextureCubeImagesLoaded(
        ...
        for (var i: number = 0; i < 6; i++) images[i] = Loader.getRes(urls[i]);

        loader._cache = loader._createCache;
        var tex: TextureCube = TextureCube._parse(
            images,
            loader._propertyParams,
            loader._constructParams,
        );
        ...
        for (i = 0; i < 6; i++) Loader.clearRes(urls[i]);
        Laya3D._endLoad(loader, tex);
    }
    ...
    static init(
        width: number,
        height: number,
        config: Config3D = null,
        compolete: Handler = null,
    ): void {
        if (Laya3D._isInit) {
        ...
        if (physics3D == null) {
            ...
            physics3D(
                config.defaultPhysicsMemory * 16,
