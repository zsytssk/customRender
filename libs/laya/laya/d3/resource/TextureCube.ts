...
export class TextureCube extends BaseTexture {
    ...
    static __init__(): void {
        ...
        pixels[1] = 128;
        pixels[2] = 128;
        TextureCube.grayTexture = new TextureCube(
            1,
            TextureFormat.R8G8B8,
            false,
        );
        TextureCube.grayTexture.setSixSidePixels([
            pixels,
            pixels,
            pixels,
            pixels,
    ...
    static _parse(
        ...
        var texture: TextureCube = constructParams
            ? new TextureCube(0, constructParams[0], constructParams[1])
            : new TextureCube(0);
    ...
    constructor(
        size: number,
        format: number = TextureFormat.R8G8B8,
    ...
    setSixSidePixels(pixels: Array<Uint8Array>, miplevel: number = 0): void {
        ...
        if (pixels[0].length < pixelsCount)
            //TODO:只判断了0层
            throw (
                'TextureCube:pixels length should at least ' + pixelsCount + '.'
            );
