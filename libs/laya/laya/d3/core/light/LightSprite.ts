...
export class LightSprite extends Sprite3D {
    ...
    set shadowDistance(value: number) {
        ...
        this._parallelSplitShadowMap &&
            this._parallelSplitShadowMap.setFarDistance(value);
    }
    ...
    set shadowResolution(value: number) {
        ...
        this._parallelSplitShadowMap &&
            this._parallelSplitShadowMap.setShadowMapTextureSize(value);
    }
    ...
    set shadowPSSMCount(value: number) {
        ...
        this._parallelSplitShadowMap &&
            (this._parallelSplitShadowMap.shadowMapCount = value);
    }
    ...
    set shadowPCFType(value: number) {
        ...
        this._parallelSplitShadowMap &&
            this._parallelSplitShadowMap.setPCFType(value);
    }
    ...
    protected _onActive(): void {
        super._onActive();
        this.lightmapBakedType !== LightSprite.LIGHTMAPBAKEDTYPE_BAKED &&
            this._addToScene();
    }
