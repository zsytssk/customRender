...
export class WebGLContext {
    ...
    static setDepthTest(gl: WebGLRenderingContext, value: boolean): void {
        value !== WebGLContext._depthTest &&
            ((WebGLContext._depthTest = value),
    ...
    static setDepthMask(gl: WebGLRenderingContext, value: boolean): void {
        value !== WebGLContext._depthMask &&
            ((WebGLContext._depthMask = value), gl.depthMask(value));
    }
    ...
    static setDepthFunc(gl: WebGLRenderingContext, value: number): void {
        value !== WebGLContext._depthFunc &&
            ((WebGLContext._depthFunc = value), gl.depthFunc(value));
    }
    ...
    static setBlend(gl: WebGLRenderingContext, value: boolean): void {
        value !== WebGLContext._blend &&
            ((WebGLContext._blend = value),
     ...
     * @internal
     */
    static setBlendEquationSeparate(
        gl: WebGLRenderingContext,
        blendEquationRGB: number,
        blendEquationAlpha: number,
    ): void {
        if (
            blendEquationRGB !== WebGLContext._blendEquationRGB ||
            blendEquationAlpha !== WebGLContext._blendEquationAlpha
        ) {
    ...
    static setBlendFunc(
        ...
        if (
            sFactor !== WebGLContext._sFactor ||
            dFactor !== WebGLContext._dFactor
        ) {
    ...
    static setBlendFuncSeperate(
        ...
        if (
            srcRGB !== WebGLContext._sFactorRGB ||
            dstRGB !== WebGLContext._dFactorRGB ||
            srcAlpha !== WebGLContext._sFactorAlpha ||
            dstAlpha !== WebGLContext._dFactorAlpha
        ) {
    ...
    static setCullFace(gl: WebGLRenderingContext, value: boolean): void {
        value !== WebGLContext._cullFace &&
            ((WebGLContext._cullFace = value),
    ...
    static setFrontFace(gl: WebGLRenderingContext, value: number): void {
        value !== WebGLContext._frontFace &&
            ((WebGLContext._frontFace = value), gl.frontFace(value));
    }
